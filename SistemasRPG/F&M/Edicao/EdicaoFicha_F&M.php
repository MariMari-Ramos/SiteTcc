    ...
    <div class="container">
        ...
        <div id="page-6" class="page">
            ...
            <div class="card section-border-pink">
                ...
                <div class="tabs">
                    <button class="tab active">Nível 0</button>
                    <button class="tab">Nível 1</button>
                    <button class="tab">Nível 2</button>
                    <button class="tab">Nível 3</button>
                    <button class="tab">Nível 4</button>
                    <button class="tab">Nível 5</button>
                </div>
                <button class="btn-add" onclick="addAbility('technique-abilities')">Adicionar Habilidade de Técnica</button>
